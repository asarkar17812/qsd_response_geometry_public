...
bounded reduced resolvent). We give all three here; the remaining verifications are routine.
...
operator-theoretic verifications we record only in sketch; the countable case
...
available at the \href{https://github.com/asarkar17812/qsd_response_geometry_public}{
\textsf{\textsc{project repository}}}; the kernels and notebook are also bundled as arXiv
ancillary files.
...
\texttt{lean/} with an executable walkthrough in \texttt{notebook/}. The Lean layer verifies only
